...
<html lang="en">
    <head>
        ...
        <!--<link rel="stylesheet" href="<?php echo base_url(); ?>css/bootstrap-reset.css" type="text/css" media="all">-->
        ...
        <!--<link rel="stylesheet" href="<?php echo base_url(); ?>assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" type="text/css" media="all">-->
        ...
        <!--right slidebar-->
        <!--<link rel="stylesheet" href="<?php echo base_url(); ?>css/slidebars.css" type="text/css" media="all">-->
